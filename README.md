...
-   ✅ Список последних пользователей - при открытии меню показываются последние 10 пользователей
-   ✅ Копируемые ID - ID в бэктиках (`) для удобного копирования
-   ✅ Кнопка "Список всех" - для просмотра полного списка с пагинацией
-   ✅ Фильтрация - не показываются забаненные пользователи в списке
